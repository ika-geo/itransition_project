    ...
    translation: {
        ...
        adminDashboard: {
            ...
            items:[
                ...
                {title: 'მომხმარებლების პასუხების მართვა', url: '/admin/manageUsersAnswers', description: 'შეცვალეთ ან წაშალეთ ნებისმიერი მომხმარებლის პასუხი.'},
                {title: 'თეგების მართვა', url: '/admin/manageTags', description: 'შეცვალეთ ან წაშალეთ ნებისმიერი ტეგი, ან დაამატეთ ახალი.'}
            ]
        },
        loading: "დაელოდეთ...",
        logOut: 'გამოსვლა',
